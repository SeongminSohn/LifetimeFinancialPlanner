...
function incomeEventManagement() {
                    ...
                    return (
                        <form key={item.eventSeriesId || index} className="investment-form">
                            <div className="login">
                                ...
                                >
                                    {viewedId === item.eventSeriesId ? 'Hide Details' : 'View Income Event Detail'}
                                </button>
                                {viewedId === item.eventSeriesId && (
                                    <div className="investment-details">
                                        ...
                                        <p><strong style={{color:"darkcyan"}}>Social Security:</strong> {item.isSocialSecurity}</p>
                                        <button
                                            type="button"
                                            style={{ backgroundColor: 'black', color: 'white', marginTop: '8px' }}
                                            onClick={() => navPage(`/income-events/edit/${item.eventSeriesId}`)}>
                                            Edit Income Event
                                        </button>
                                    </div>
                                )}
...
export default incomeEventManagement;
